...
public class PacketMine extends Module {
    ...
    public class MyBlock {
        ...
        private void sendMinePackets() {
            ...
            if (mining && obscureBreakingProgress.get()) mc.getConnection().send(new ServerboundPlayerActionPacket(ServerboundPlayerActionPacket.Action.ABORT_DESTROY_BLOCK, blockPos, direction));
        }
