...
public class VeinMiner extends Module {
    ...
    private void mineNearbyBlocks(Item item, BlockPos pos, Direction dir, int depth) {
        ...
        if (Utils.distance(mc.player.getX() - 0.5, mc.player.getY() + mc.player.getEyeHeight(mc.player.getPose()), mc.player.getZ() - 0.5, pos.getX(), pos.getY(), pos.getZ()) > mc.player.blockInteractionRange()) return;
