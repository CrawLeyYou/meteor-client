...
public class AutoMount extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        for (Entity entity : mc.level.entitiesForRendering()) {
            ...
            if ((entity instanceof Pig || entity instanceof SkeletonHorse || entity instanceof Strider || entity instanceof ZombieHorse) && !((Mob) entity).isSaddled()) continue;
            if (!(entity instanceof Llama) && entity instanceof Mob mobEntity && checkSaddle.get() && !mobEntity.isSaddled()) continue;
