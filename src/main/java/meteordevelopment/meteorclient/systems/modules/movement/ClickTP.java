...
public class ClickTP extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (mc.hitResult != null) {
            if (mc.hitResult.getType() == HitResult.Type.ENTITY && mc.player.interactOn(((EntityHitResult) mc.hitResult).getEntity(), InteractionHand.MAIN_HAND) != InteractionResult.PASS) return;
